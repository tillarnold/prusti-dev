...
impl<'p, 'v, 'r: 'v, 'a: 'r, 'tcx: 'a> SnapshotEncoder<'p, 'v, 'tcx> {
    ...
    fn encode_snap_func_primitive(&self, field: vir::Field) -> vir::Function {
        ...
        let body = self.encode_snap_arg_field(
    ...
    fn encode_enum_snap_domain(
        ...
        adt_def: &ty::AdtDef,
        subst: ty::subst::SubstsRef<'tcx>,
    ) -> PositionlessEncodingResult<SnapshotDomain>
    {
        Ok(SnapshotDomain{
    ...
    fn encode_enum_domain(
        ...
        adt_def: &ty::AdtDef,
        subst: ty::subst::SubstsRef<'tcx>,
    ) -> PositionlessEncodingResult<vir::Domain>
    {
    ...
    fn encode_enum_constructors(
        ...
        adt_def: &ty::AdtDef,
        subst: ty::subst::SubstsRef<'tcx>,
    ) -> PositionlessEncodingResult<Vec<vir::DomainFunc>>
    {
        let mut result = vec![];
    ...
    fn encode_enum_predicate(
        &self,
    ) -> PositionlessEncodingResult<vir::EnumPredicate>
    {
